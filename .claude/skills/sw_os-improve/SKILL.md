...
**In plain English:** Your design partner for making sw_os better. Three ways to use it:
...
**How to run it:**
```
/sw_os-improve                           # Shows menu of options
/sw_os-improve "your idea here"          # Jumps straight to workshopping
```
...
1. Identify which sw_os areas are involved:
...
2. Save to `plans/sw_os-improvement-[slug].md`
...
4. **For each new feature, evaluate:**
   - Is this relevant to sw_os use cases?
...
1. [Feature Name]
   ...
   - How it could help: [specific sw_os improvement]
...
Create at: `plans/sw_os-improvement-[slug].md`

```markdown
# sw_os Improvement: [Title]
...
### Mode 1: Workshop
```
/sw_os-improve "Better meeting action item capture"
