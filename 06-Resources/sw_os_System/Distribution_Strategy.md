# sw_os Distribution Strategy

**Last Updated:** January 29, 2026

This document explains how sw_os handles updates, customizations, and distribution to users.

---

## Core Philosophy

**sw_os is yours, not ours.**

When users clone sw_os, they get a complete copy that they customize heavily:
- Rename folders
- Modify skills
...
sw_os uses the "framework model" - users maintain their own repo with the main sw_os repo as an upstream source.
...
**User experience:**
```
🎁 sw_os v1.3.0 is available. Run /dex-whats-new for details.
...
4. Update sw_os: git fetch upstream && git merge upstream/main
...
**Step 1:** Get notified
- During `/daily-plan`: "🎁 sw_os v1.3.0 is available"
...
- **User Guide:** `06-Resources/sw_os_System/Updating_Dex.md`
- **Migration README:** `core/migrations/README.md`
- **Technical Guide:** `06-Resources/sw_os_System/Dex_Technical_Guide.md` (MCP section)
