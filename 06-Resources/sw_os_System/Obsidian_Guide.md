...
2. Open your sw_os vault: File → Open Folder → Select your sw_os directory
...
Already using sw_os without Obsidian? No problem.
...
Consider these community plugins for enhanced sw_os experience:
