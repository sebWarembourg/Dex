# AI Model Options for sw_os

**Quick setup:** Run `/ai-setup` in sw_os — I'll guide you through everything.

---

## Overview

sw_os can use different AI models depending on your needs:
...
Let sw_os automatically pick the best model for each task:
...
A: sw_os will let you know and offer to set it up when you're back online. You can still browse/edit files manually.

---

## Related

- [sw_os System Guide](Dex_System_Guide.md) — Full system documentation
- [sw_os Technical Guide](Dex_Technical_Guide.md) — Advanced configuration
