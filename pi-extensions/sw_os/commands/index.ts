...
/**
 * Register all sw_os commands
 */
export function registerCommands(pi: ExtensionAPI, vaultRoot: string): void {
  // ============================================================
  // /status - Quick sw_os status overview
  // ============================================================
  pi.registerCommand("status", {
    description: "Quick sw_os status overview (tasks, inbox, reminders)",
  ...
  // ============================================================
  // /dex - sw_os help and feature overview
  // ============================================================
  pi.registerCommand("sw_os", {
    description: "Show sw_os help and available Pi commands",
    handler: async (args, ctx) => {
      const help = `
# sw_os Pi Extension
...
Run any command or ask me about sw_os features!
`.trim();

      ctx.ui.setEditorText(help);
      ctx.ui.notify("sw_os help loaded", "info");
    },
  });
}
