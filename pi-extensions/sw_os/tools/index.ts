/**
 * Custom Tools Module
 * Pi-exclusive tools that enhance sw_os functionality
 * 
...
export function registerTools(pi: ExtensionAPI, vaultRoot: string): void {
  ...
  pi.registerTool({
    ...
    description:
      "Search across the entire sw_os vault for content, people, projects, or tasks. " +
  ...
  pi.registerTool({
    ...
    label: "Pi sw_os Task",
    description:
      "Create, complete, or list tasks in sw_os. " +
  ...
  // ============================================================
  // DEX STATUS TOOL
  // Quick overview of sw_os state
  // ============================================================
  pi.registerTool({
    name: "pi_dex_status",
    label: "Pi sw_os Status",
    description: "Get a quick overview of sw_os state: tasks, inbox, and recent activity.",
    parameters: Type.Object({}),
