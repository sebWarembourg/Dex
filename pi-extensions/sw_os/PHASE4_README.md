# sw_os for Pi - Phase 4: Rich TUI Components
...
Phase 4 adds rich, interactive TUI components that transform sw_os from a functional system into a delightful experience.
...
The sw_os extension should load automatically and show `● sw_os` in the footer.
